                ...
                {["000","00","0",""].map( (zeros, index) => {
                        return (
                            <Fragment>
                                <Grid2 size={2}>
                                    <Collapse in={rowRevealed[0]}>
                                        <Typography variant="h4" sx={{marginBottom: '2rem'}} color={yellow} align="center">
                                            {typeof randomBinaryNumbers[0] === "string" && randomBinaryNumbers[0].at(index) === "1" ? "1" + zeros  : "0" + zeros}
                                        </Typography>
                                    </Collapse>
                                </Grid2>
                                {(index < 3) && (
                            ...
                            <Fragment>
                                <Grid2 size={2}>
                                    <Collapse in={rowRevealed[1]}>
                                        <Typography variant="h4" sx={{marginBottom: '2rem'}} align="center">
                                            {typeof randomBinaryNumbers[0] === "string" && randomBinaryNumbers[0].at(index) === "1" ? "1" : "0"}•2<sup>{exponent}</sup>
                                        </Typography>
                                    </Collapse>
                                </Grid2>
                                {(index < 3) && (
                            ...
                            <Fragment>
                                <Grid2 size={2}>
                                    <Collapse in={rowRevealed[2]}>
                                        <Typography variant="h4" sx={{marginBottom: '2rem'}} align="center">
                                            {typeof randomBinaryNumbers[0] === "string" && randomBinaryNumbers[0].at(index) === "1" ? potency : "0"}
                                        </Typography>
                                    </Collapse>
                                </Grid2>
                                {(index < 3) && (
