...
export const fetchLeaderboardData = async (selectedCategory, setLoading, setError, setLeaderboardData) => {
    setLoading(true);
    setError(null);
    try {
        const rawData = await collectLeaderboardData(selectedCategory); // Call Raw Data
        const formattedData = formatAndSortLeaderboardData(rawData, selectedCategory); // Formate and Sort Raw Data
