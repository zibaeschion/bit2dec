    ...
    return (
        ...
        >
            ...
            <Typography variant="h4" className={"gameMessage"}>
                {isCorrect ? 'Correct!' : 'What is the sum of the two binary numbers?'}
            </Typography>
            ...
            <Grid2 columns={12} container spacing={0} width={solutionShown ? "70%" : "50%"}>
                ...
                {correctBinaryAnswer && Array.from(correctBinaryAnswer.replace(/\s/g, '')).map((bit, bitIndex) => {
                    ...
                    const bitPower = correctBinaryAnswer.replace(/\s/g, '').length - 1 - bitIndex;
                    ...
                    return (
                        ...
                        <Fragment key={`result-${bitIndex}`}>
                            ...
                            {bitIndex < correctBinaryAnswer.replace(/\s/g, '').length - 1 && (
                                <Grid2 size={1}>
                                    <Collapse in={rowRevealed[1]}>
                                        <Typography variant="h4" className={"mathsHintGridTypo"}>
                                            +
